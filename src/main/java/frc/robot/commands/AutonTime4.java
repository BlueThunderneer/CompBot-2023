...
public class AutonTime4 extends SequentialCommandGroup {
  /**
   ...
   * 
   */
  public AutonTime4(ClawSS m_ClawSS, DriveSubsystem m_drivetrain, ArmSS m_armss, Vision m_vision) {
       addCommands(
        ...
        new DriveTime( 0.6, 0.0, 3.0, m_drivetrain), // go forwards for X seconds
        //lock on target
        new Target(m_drivetrain, m_vision),
        //arm down
        new armdownTime(0.8, m_armss), //Raise the Cargo arm to shoot need to add this subsystem to the contstructor)
        //extend arm maybe use the distance sensor to stop
        new extendTime(1.7, m_armss),
        //close claw
        new ItsAntiClawinTime(1.0, m_ClawSS), // Not a Morbius reference (Opens le claw)
